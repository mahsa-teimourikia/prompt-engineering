...
2. **Phase B — beginner:** in progress. Courses 01–02 now live in canonical folders with standalone READMEs, credential-free notebooks, `lab.py`, and Hub entries. Build courses 03–05 to the same standard before renumbering the full beginner track.
