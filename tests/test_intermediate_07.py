...
def test_course_07_workflow_and_constraints():
    ...
    assert results["terminal_accuracy"].numerator == 3
    assert lab07.refund_eligible("ORD-8812", tenant="tenant-synthetic-a") == "ineligible"
    assert lab07.refund_eligible("ORD-8813", tenant="tenant-synthetic-a") == "eligible"
    assert lab07.refund_eligible("ORD-8813", tenant="tenant-synthetic-b") == "not_found"
