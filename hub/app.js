...
function renderWorkspace() {
  ...
  labLink.className = "button";
  labLink.href = link(selected.lab);
  labLink.target = "_blank";
  labLink.textContent = "Open reusable lab ↗";
  workspace.querySelector(".lesson-grid article").insertBefore(labLink, workspace.querySelector("#complete"));
